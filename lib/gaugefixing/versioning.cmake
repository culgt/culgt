...
function( writeVersionString )
    execute_process( COMMAND bash -c "echo '${NEW_VERSION_STRING}' > ${CMAKE_CURRENT_LIST_DIR}/version" )
...
if( IS_GIT_DIRECTORY )
    ...
    if( EXISTS ${CMAKE_CURRENT_LIST_DIR}/version )
        execute_process( COMMAND cat "${CMAKE_CURRENT_LIST_DIR}/version" OUTPUT_VARIABLE OLD_VERSION_STRING OUTPUT_STRIP_TRAILING_WHITESPACE )
