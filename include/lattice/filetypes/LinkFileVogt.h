...
template<typename MemoryConfigurationPattern, typename TFloatFile = typename MemoryConfigurationPattern::PARAMTYPE::REALTYPE> class LinkFileVogt: public LinkFile<MemoryConfigurationPattern>
{
private:
	short ndim;
	short nc;
