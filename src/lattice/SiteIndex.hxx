...
/**
 * // TODO
 * If par == false this simpliy sets the given index, if par == false the index has to be converted to the split index.
 */
...
/**
 * TODO
 * Returns the index within a timeslice, i.e. modulo size[0]
