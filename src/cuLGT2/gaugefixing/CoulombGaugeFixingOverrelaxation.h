...
#ifndef COULOMBGAUGEFIXINGOVERRELAXATION_H_
#define COULOMBGAUGEFIXINGOVERRELAXATION_H_
...
namespace CoulombGaugeFixingOverrelaxationKernel
{
	template<typename GlobalLinkType, typename LocalLinkType, int ThreadsPerSite, int SitesPerBlock, int MinBlocksPerMultiprocessor> __global__ __launch_bounds__(ThreadsPerSite*SitesPerBlock,MinBlocksPerMultiprocessor) void kernelOrStep( typename GlobalLinkType::PATTERNTYPE::PARAMTYPE::TYPE* Ut, typename GlobalLinkType::PATTERNTYPE::PARAMTYPE::TYPE* UtDown, lat_index_t latticeSize, lat_index_t* nn, bool parity, typename LocalLinkType::PARAMTYPE::REALTYPE orParameter)
	{
...
template<typename GlobalLinkType, typename LocalLinkType> class CoulombGaugeFixingOverrelaxation: public CoulombGaugeTunableObject<GlobalLinkType,LocalLinkType>
{
public:
