...
TEST_F( ALocalLinkWithSU3Real12AndSU3Real18, OperatorEqualCopiesForSameParamType )
{
	link12_1.set(1, 2.42);
	link12_2 = link12_1;
...
TEST_F( ALocalLinkWithSU3Real12AndSU3Real18, OperatorEqualDoesNotUseReference )
{
	link12_1.set(1, 2.42);
	link12_2 = link12_1;
	link12_2.set(1, 1.3 );
...
TEST_F( ALocalLinkWithSU3Real12AndSU3Real18, OperatorEqualCopiesFromReal18ToReal12 )
{
	link18.set(1, 2.42);
	link12_1 = link18;
	ASSERT_FLOAT_EQ( 2.42, link12_1.get(1) );
...
TEST_F( ALocalLinkWithSU3Real12AndSU3Real18, OperatorEqualCopiesFromReal12ToReal18 )
{
	link12_1.set(1, 2.42);
	link18 = link12_1;
	ASSERT_FLOAT_EQ( 2.42, link18.get(1) );
...
TEST_F( ALocalLinkWithSU3Real12AndSU3Real18, OperatorEqualCopiesFromReal12ToReal18AndReconstructsThirdLine )
{
