...
//template<typename Site, lat_dim_t Ndim, typename ParamType> class StandardPattern
//{
//public:
//	static lat_array_index_t getIndex( const Site& site, lat_dim_t mu, lat_group_index_t paramIndex )
//	{
//		return (site.getIndex()*Ndim+mu)*ParamType::SIZE+paramIndex;
//	}
//
//	/**
...
//	{
//		return (siteIndex*Ndim+mu)*ParamType::SIZE+paramIndex;
//	}
//};
